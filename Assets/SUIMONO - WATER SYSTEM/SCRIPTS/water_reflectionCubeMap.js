...
function RenderUpdate () {
	...
	tempCam.GetComponent.<Camera>().farClipPlane = Camera.main.GetComponent.<Camera>().farClipPlane;
	tempCam.GetComponent.<Camera>().nearClipPlane = clipDistance;
    ...
    tempCam.GetComponent.<Camera>().enabled = true;
    tempCam.GetComponent.<Camera>().RenderToCubemap( cubemap,cubemapFacemask );
    tempCam.GetComponent.<Camera>().enabled = false;
   
    
    //Assign Cubemap to shader
    GetComponent.<Renderer>().material.SetTexture("_CubeTex2",cubemap);
