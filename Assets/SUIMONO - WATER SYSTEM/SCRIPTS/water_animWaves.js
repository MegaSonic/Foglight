...
systemSpeed = transform.parent.renderer.material.GetFloat("_AnimSpeed");
animationSpeed = renderer.material.GetFloat("_AnimSpeed")*systemSpeed;
...
renderer.material.SetTextureOffset("_WaveTex",Vector2(wave_speed.x*Time.time*animationSpeed,wave_speed.y*Time.time*animationSpeed));
renderer.material.SetTextureOffset("_WaveTex",Vector2(wave_speed.x*Time.time*animationSpeed,wave_speed.y*Time.time*animationSpeed));
