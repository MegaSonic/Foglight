...
if (transitionPreset){
	...
	GetComponent.<Renderer>().material.SetTextureScale("_HeightMap",Vector2.Lerp(GetPreset(waterStartState,"_HeightMap"),GetPreset(waterTargetState,"_HeightMap"),transitionTime));
	GetComponent.<Renderer>().material.SetTextureScale("_HeightMap2",Vector2.Lerp(GetPreset(waterStartState,"_HeightMap2"),GetPreset(waterTargetState,"_HeightMap2"),transitionTime));
	GetComponent.<Renderer>().material.SetFloat("_IlluminColor",Mathf.Lerp(GetPreset(waterStartState,"_IlluminColor"),GetPreset(waterTargetState,"_IlluminColor"),transitionTime));
	
	GetComponent.<Renderer>().material.SetColor("_SpecColor", Color.Lerp(GetPreset(waterStartState,"_SpecColor"),GetPreset(waterTargetState,"_SpecColor"),transitionTime));
	GetComponent.<Renderer>().material.SetColor("_SurfaceColor",Color.Lerp(GetPreset(waterStartState,"_SurfaceColor"),GetPreset(waterTargetState,"_SurfaceColor"),transitionTime));
	GetComponent.<Renderer>().material.SetColor("_DepthColor",Color.Lerp(GetPreset(waterStartState,"_DepthColor"),GetPreset(waterTargetState,"_DepthColor"),transitionTime));
	GetComponent.<Renderer>().material.SetColor("_EdgeColor",Color.Lerp(GetPreset(waterStartState,"_EdgeColor"),GetPreset(waterTargetState,"_EdgeColor"),transitionTime));
	GetComponent.<Renderer>().material.SetColor("_DistColor",Color.Lerp(GetPreset(waterStartState,"_DistColor"),GetPreset(waterTargetState,"_DistColor"),transitionTime));
	GetComponent.<Renderer>().material.SetColor("_FoamColor",Color.Lerp(GetPreset(waterStartState,"_FoamColor"),GetPreset(waterTargetState,"_FoamColor"),transitionTime));
	GetComponent.<Renderer>().material.SetColor("_FogColor",Color.Lerp(GetPreset(waterStartState,"_FogColor"),GetPreset(waterTargetState,"_FogColor"),transitionTime));
	GetComponent.<Renderer>().material.SetColor("_ReflColor",Color.Lerp(GetPreset(waterStartState,"_ReflColor"),GetPreset(waterTargetState,"_ReflColor"),transitionTime));
	GetComponent.<Renderer>().material.SetColor("_ReflColor2",Color.Lerp(GetPreset(waterStartState,"_ReflColor2"),GetPreset(waterTargetState,"_ReflColor2"),transitionTime));
	GetComponent.<Renderer>().material.SetColor("_ReflColor3",Color.Lerp(GetPreset(waterStartState,"_ReflColor3"),GetPreset(waterTargetState,"_ReflColor3"),transitionTime));
		
	GetComponent.<Renderer>().material.SetFloat("_ReflDist",Mathf.Lerp(GetPreset(waterStartState,"_ReflDist"),GetPreset(waterTargetState,"_ReflDist"),transitionTime));
	GetComponent.<Renderer>().material.SetFloat("_ReflBlend",Mathf.Lerp(GetPreset(waterStartState,"_ReflBlend"),GetPreset(waterTargetState,"_ReflBlend"),transitionTime));
																	
	GetComponent.<Renderer>().material.SetFloat("_FogFar",Mathf.Lerp(GetPreset(waterStartState,"_FogFar"),GetPreset(waterTargetState,"_FogFar"),transitionTime));
	GetComponent.<Renderer>().material.SetFloat("_FogAlpha",Mathf.Lerp(GetPreset(waterStartState,"_FogAlpha"),GetPreset(waterTargetState,"_FogAlpha"),transitionTime));
	GetComponent.<Renderer>().material.SetFloat("_DepthAmt",Mathf.Lerp(GetPreset(waterStartState,"_DepthAmt"),GetPreset(waterTargetState,"_DepthAmt"),transitionTime));
	GetComponent.<Renderer>().material.SetFloat("_EdgeAmt",Mathf.Lerp(GetPreset(waterStartState,"_EdgeAmt"),GetPreset(waterTargetState,"_EdgeAmt"),transitionTime));
	GetComponent.<Renderer>().material.SetFloat("_EdgeBlend",Mathf.Lerp(GetPreset(waterStartState,"_EdgeBlend"),GetPreset(waterTargetState,"_EdgeBlend"),transitionTime));
	GetComponent.<Renderer>().material.SetFloat("_DistFar",Mathf.Lerp(GetPreset(waterStartState,"_DistFar"),GetPreset(waterTargetState,"_DistFar"),transitionTime));
	GetComponent.<Renderer>().material.SetFloat("_DistBlend",Mathf.Lerp(GetPreset(waterStartState,"_DistBlend"),GetPreset(waterTargetState,"_DistBlend"),transitionTime));
	GetComponent.<Renderer>().material.SetFloat("_FoamAmt",Mathf.Lerp(GetPreset(waterStartState,"_FoamAmt"),GetPreset(waterTargetState,"_FoamAmt"),transitionTime));
	GetComponent.<Renderer>().material.SetFloat("_FoamBlend",Mathf.Lerp(GetPreset(waterStartState,"_FoamBlend"),GetPreset(waterTargetState,"_FoamBlend"),transitionTime));
	
	GetComponent.<Renderer>().material.SetFloat("_Emissive",Mathf.Lerp(GetPreset(waterStartState,"_Emissive"),GetPreset(waterTargetState,"_Emissive"),transitionTime));
	GetComponent.<Renderer>().material.SetFloat("_BumpStrength",Mathf.Lerp(GetPreset(waterStartState,"_BumpStrength"),GetPreset(waterTargetState,"_BumpStrength"),transitionTime));
	GetComponent.<Renderer>().material.SetFloat("_SpecStrength",Mathf.Lerp(GetPreset(waterStartState,"_SpecStrength"),GetPreset(waterTargetState,"_SpecStrength"),transitionTime));
	GetComponent.<Renderer>().material.SetFloat("_Wetness",Mathf.Lerp(GetPreset(waterStartState,"_Wetness"),GetPreset(waterTargetState,"_Wetness"),transitionTime));
	
	GetComponent.<Renderer>().material.SetFloat("_RefrStrength",Mathf.Lerp(GetPreset(waterStartState,"_RefrStrength"),GetPreset(waterTargetState,"_RefrStrength"),transitionTime));
	...
	if (transitionTime >= 1.0){
		//set collider at end
		GetComponent.<Collider>().isTrigger = GetPreset(waterTargetState,"collider");
		GetComponent.<Renderer>().material.SetFloat("_RefrSpeed",GetPreset(waterTargetState,"_RefrSpeed"));
		GetComponent.<Renderer>().material.SetFloat("_AnimSpeed",GetPreset(waterTargetState,"_AnimSpeed"));
...
if (publishPreset){
	...
	if (GetComponent.<Collider>() != null){
		if (GetComponent.<Collider>().isTrigger) collStr = "true";
	}
	printPreset += "	if(pSetting == \"collider\") return "+collStr+";\n";
	printPreset += "	//set UVs\n";
	printPreset += "	if(pSetting == \"_HeightMap\") return Vector2("+GetComponent.<Renderer>().material.GetTextureScale("_HeightMap").x+","+GetComponent.<Renderer>().material.GetTextureScale("_HeightMap").y+");\n";
	printPreset += "	if(pSetting == \"_HeightMap2\") return Vector2("+GetComponent.<Renderer>().material.GetTextureScale("_HeightMap2").x+","+GetComponent.<Renderer>().material.GetTextureScale("_HeightMap2").x+");\n";
	printPreset += "	if(pSetting == \"_FoamTex\") return Vector2("+GetComponent.<Renderer>().material.GetTextureScale("_FoamTex").x+","+GetComponent.<Renderer>().material.GetTextureScale("_FoamTex").x+");\n";
	printPreset += "	//set Illumination Value\n";
	printPreset += "	if(pSetting == \"_IlluminColor\") return "+GetComponent.<Renderer>().material.GetFloat("_IlluminColor")+";\n";
	printPreset += "	//set colors\n";
	setcol = GetComponent.<Renderer>().material.GetColor("_SpecColor");
	printPreset += "	if(pSetting == \"_SpecColor\") return Color("+setcol.r+","+setcol.g+","+setcol.b+","+setcol.a+");\n";
	setcol = GetComponent.<Renderer>().material.GetColor("_SurfaceColor");
	printPreset += "	if(pSetting == \"_SurfaceColor\") return Color("+setcol.r+","+setcol.g+","+setcol.b+","+setcol.a+");\n";
	setcol = GetComponent.<Renderer>().material.GetColor("_DepthColor");
	printPreset += "	if(pSetting == \"_DepthColor\") return Color("+setcol.r+","+setcol.g+","+setcol.b+","+setcol.a+");\n";
	setcol = GetComponent.<Renderer>().material.GetColor("_EdgeColor");
	printPreset += "	if(pSetting == \"_EdgeColor\") return Color("+setcol.r+","+setcol.g+","+setcol.b+","+setcol.a+");\n";
	setcol = GetComponent.<Renderer>().material.GetColor("_DistColor");
	printPreset += "	if(pSetting == \"_DistColor\") return Color("+setcol.r+","+setcol.g+","+setcol.b+","+setcol.a+");\n";
	setcol = GetComponent.<Renderer>().material.GetColor("_FoamColor");
	printPreset += "	if(pSetting == \"_FoamColor\") return Color("+setcol.r+","+setcol.g+","+setcol.b+","+setcol.a+");\n";
	setcol = GetComponent.<Renderer>().material.GetColor("_FogColor");
	printPreset += "	if(pSetting == \"_FogColor\") return Color("+setcol.r+","+setcol.g+","+setcol.b+","+setcol.a+");\n";
	setcol = GetComponent.<Renderer>().material.GetColor("_ReflColor");
	printPreset += "	if(pSetting == \"_ReflColor\") return Color("+setcol.r+","+setcol.g+","+setcol.b+","+setcol.a+");\n";
	setcol = GetComponent.<Renderer>().material.GetColor("_ReflColor2");
	printPreset += "	if(pSetting == \"_ReflColor2\") return Color("+setcol.r+","+setcol.g+","+setcol.b+","+setcol.a+");\n";
	setcol = GetComponent.<Renderer>().material.GetColor("_ReflColor3");
	...
	printPreset += "	if(pSetting == \"_ReflDist\") return "+GetComponent.<Renderer>().material.GetFloat("_ReflDist")+";\n";
	printPreset += "	if(pSetting == \"_ReflBlend\") return "+GetComponent.<Renderer>().material.GetFloat("_ReflBlend")+";\n";
	printPreset += "	if(pSetting == \"_FogFar\") return "+GetComponent.<Renderer>().material.GetFloat("_FogFar")+";\n";
	printPreset += "	if(pSetting == \"_FogAlpha\") return "+GetComponent.<Renderer>().material.GetFloat("_FogAlpha")+";\n";
	printPreset += "	if(pSetting == \"_DepthAmt\") return "+GetComponent.<Renderer>().material.GetFloat("_DepthAmt")+";\n";
	printPreset += "	if(pSetting == \"_EdgeAmt\") return "+GetComponent.<Renderer>().material.GetFloat("_EdgeAmt")+";\n";
	printPreset += "	if(pSetting == \"_EdgeBlend\") return "+GetComponent.<Renderer>().material.GetFloat("_EdgeBlend")+";\n";
	printPreset += "	if(pSetting == \"_DistFar\") return "+GetComponent.<Renderer>().material.GetFloat("_DistFar")+";\n";
	printPreset += "	if(pSetting == \"_DistBlend\") return "+GetComponent.<Renderer>().material.GetFloat("_DistBlend")+";\n";
	printPreset += "	if(pSetting == \"_FoamAmt\") return "+GetComponent.<Renderer>().material.GetFloat("_FoamAmt")+";\n";
	printPreset += "	if(pSetting == \"_FoamBlend\") return "+GetComponent.<Renderer>().material.GetFloat("_FoamBlend")+";\n";
	printPreset += "	//set norm and spec parameters\n";
	printPreset += "	if(pSetting == \"_Emissive\") return "+GetComponent.<Renderer>().material.GetFloat("_Emissive")+";\n";
	printPreset += "	if(pSetting == \"_BumpStrength\") return "+GetComponent.<Renderer>().material.GetFloat("_BumpStrength")+";\n";
	printPreset += "	if(pSetting == \"_SpecStrength\") return "+GetComponent.<Renderer>().material.GetFloat("_SpecStrength")+";\n";
	printPreset += "	if(pSetting == \"_Wetness\") return "+GetComponent.<Renderer>().material.GetFloat("_Wetness")+";\n";
	printPreset += "	//set refraction parameters\n";
	printPreset += "	if(pSetting == \"_RefrStrength\") return "+GetComponent.<Renderer>().material.GetFloat("_RefrStrength")+";\n";
	printPreset += "	if(pSetting == \"_RefrSpeed\") return "+GetComponent.<Renderer>().material.GetFloat("_RefrSpeed")+";\n";
	printPreset += "	//set animation speed parameter\n";
	printPreset += "	if(pSetting == \"_AnimSpeed\") return "+GetComponent.<Renderer>().material.GetFloat("_AnimSpeed")+";\n";
	printPreset += "}\n\n";
...
if (GetComponent.<Collider>() != null){
	GetComponent.<Collider>().isTrigger = GetPreset(aspSet,"collider");
}
GetComponent.<Renderer>().material.SetTextureScale("_HeightMap",GetPreset(aspSet,"_HeightMap"));
GetComponent.<Renderer>().material.SetTextureScale("_HeightMap2",GetPreset(aspSet,"_HeightMap2"));
GetComponent.<Renderer>().material.SetTextureScale("_FoamTex",GetPreset(aspSet,"_FoamTex"));
GetComponent.<Renderer>().material.SetFloat("_IlluminColor",GetPreset(aspSet,"_IlluminColor"));

GetComponent.<Renderer>().material.SetColor("_SpecColor",GetPreset(aspSet,"_SpecColor"));
GetComponent.<Renderer>().material.SetColor("_SurfaceColor",GetPreset(aspSet,"_SurfaceColor"));
GetComponent.<Renderer>().material.SetColor("_DepthColor",GetPreset(aspSet,"_DepthColor"));
GetComponent.<Renderer>().material.SetColor("_EdgeColor",GetPreset(aspSet,"_EdgeColor"));
GetComponent.<Renderer>().material.SetColor("_DistColor",GetPreset(aspSet,"_DistColor"));
GetComponent.<Renderer>().material.SetColor("_FoamColor",GetPreset(aspSet,"_FoamColor"));
GetComponent.<Renderer>().material.SetColor("_FogColor",GetPreset(aspSet,"_FogColor"));
GetComponent.<Renderer>().material.SetColor("_ReflColor",GetPreset(aspSet,"_ReflColor"));
GetComponent.<Renderer>().material.SetColor("_ReflColor2",GetPreset(aspSet,"_ReflColor2"));
GetComponent.<Renderer>().material.SetColor("_ReflColor3",GetPreset(aspSet,"_ReflColor3"));

GetComponent.<Renderer>().material.SetFloat("_ReflDist",GetPreset(aspSet,"_ReflDist"));
GetComponent.<Renderer>().material.SetFloat("_ReflBlend",GetPreset(aspSet,"_ReflBlend"));

GetComponent.<Renderer>().material.SetFloat("_FogFar",GetPreset(aspSet,"_FogFar"));
GetComponent.<Renderer>().material.SetFloat("_FogAlpha",GetPreset(aspSet,"_FogAlpha"));
GetComponent.<Renderer>().material.SetFloat("_DepthAmt",GetPreset(aspSet,"_DepthAmt"));
GetComponent.<Renderer>().material.SetFloat("_EdgeAmt",GetPreset(aspSet,"_EdgeAmt"));
GetComponent.<Renderer>().material.SetFloat("_EdgeBlend",GetPreset(aspSet,"_EdgeBlend"));
GetComponent.<Renderer>().material.SetFloat("_DistFar",GetPreset(aspSet,"_DistFar"));
GetComponent.<Renderer>().material.SetFloat("_DistBlend",GetPreset(aspSet,"_DistBlend"));
GetComponent.<Renderer>().material.SetFloat("_FoamAmt",GetPreset(aspSet,"_FoamAmt"));
GetComponent.<Renderer>().material.SetFloat("_FoamBlend",GetPreset(aspSet,"_FoamBlend"));

GetComponent.<Renderer>().material.SetFloat("_Emissive",GetPreset(aspSet,"_Emissive"));
GetComponent.<Renderer>().material.SetFloat("_BumpStrength",GetPreset(aspSet,"_BumpStrength"));
GetComponent.<Renderer>().material.SetFloat("_SpecStrength",GetPreset(aspSet,"_SpecStrength"));
GetComponent.<Renderer>().material.SetFloat("_Wetness",GetPreset(aspSet,"_Wetness"));

GetComponent.<Renderer>().material.SetFloat("_RefrStrength",GetPreset(aspSet,"_RefrStrength"));
GetComponent.<Renderer>().material.SetFloat("_RefrSpeed",GetPreset(aspSet,"_RefrSpeed"));

GetComponent.<Renderer>().material.SetFloat("_AnimSpeed",GetPreset(aspSet,"_AnimSpeed"));
