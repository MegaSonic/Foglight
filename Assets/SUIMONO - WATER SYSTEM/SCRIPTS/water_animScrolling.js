...
GetComponent.<Renderer>().material.SetTextureOffset("_HeightMap",Vector2(flow_speed.x*Time.time*animationSpeed,flow_speed.y*Time.time*animationSpeed));
GetComponent.<Renderer>().material.SetTextureOffset("_HeightMap2",Vector2(wave_speed.x*Time.time*animationSpeed,wave_speed.y*Time.time*animationSpeed));
